<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
          v-hasPermi="['pet:info:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
          v-hasPermi="['pet:info:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['pet:info:remove']">删除</el-button>
      </el-col>
      <!-- <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['pet:info:export']">导出</el-button>
      </el-col> -->
    ...
    <el-table v-loading="loading" :data="infoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="生活习惯" align="center" prop="habitsAndCustoms" />
      <el-table-column label="创建者姓名" align="center" prop="createByName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="健康状况" prop="healthCondition">
          <el-input v-model="form.healthCondition" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="生活习惯" prop="habitsAndCustoms">
          <el-input v-model="form.habitsAndCustoms" type="textarea" placeholder="请输入内容" />
        </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        habitsAndCustoms: [
          { required: true, message: "生活习惯不能为空", trigger: "blur" }
        ],
      }
    };
  },
