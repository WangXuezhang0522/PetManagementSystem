  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <!-- <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
          v-hasPermi="['system:shoppingCart:add']">新增</el-button>
      </el-col> -->
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
          v-hasPermi="['system:shoppingCart:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['system:shoppingCart:remove']">删除</el-button>
      </el-col>
      <!-- <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['system:shoppingCart:export']">导出</el-button>
      </el-col> -->
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" :disabled="multiple" @click="handleOrder"
          v-hasPermi="['order:info:order']">下单</el-button>
      </el-col>
    ...
    <el-dialog :title="title1" :visible.sync="open1" width="500px" append-to-body>
      <el-form ref="form1" :model="form1" :rules="rules1" label-width="80px">
        <el-form-item label="收货地址" prop="sysUserAddressId">
          <el-select v-model="form1.sysUserAddressId" placeholder="请选择收货地址" style="width: 100%;">
            <el-option v-for="item in addressList" :key="item.id"
              :label="item.recipient + '-' + item.phonenumber + '-' + item.province + '-' + item.city + '-' + item.area"
              :value="item.id"></el-option>
          </el-select>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submitForm1">确定下单并支付</el-button>
...
import { getGenerateOrder } from "@/api/order/info";
  ...
  methods: {
    ...
    submitForm1() {
      this.$refs["form1"].validate(valid => {
        if (valid) {
          getGenerateOrder(this.form1).then(response => {
